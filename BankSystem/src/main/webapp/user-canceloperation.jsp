                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5" style="margin-bottom: -17px;padding-top: 91px;padding-bottom: 91px;margin-top: 3px;">
                            ...
                            <form method="post">
                                <div class="text-center mb-3" style="margin-top: -27px;"><sub>Do you want to cancel latest payment?</sub></div>
                                <div class="bg-light border rounded border-3 shadow d-flex align-items-lg-center" style="margin-top: 10px;margin-bottom: 10px;margin-left: -25px;margin-right: -25px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cash text-primary" style="font-size: 46px;margin-left: 8px;margin-right: 8px;">
                                    ...
                                    <div>
                                        <p class="fw-bold text-primary mb-0">Milk and chocolate ad the bar</p>
                                        <p class="text-muted mb-0">3028XXXXXXXXXXX</p>
                                    </div>
                                    <div></div><small class="fs-5 fw-semibold text-end d-lg-flex flex-fill justify-content-lg-end align-items-lg-center" style="margin-right: 8px;">-5.00€</small>
                                </div>
                                <div class="text-center">
                                    <div class="btn-group" role="group"><button class="btn btn-primary" type="button" style="background: var(--bs-red);border-color: var(--bs-red);">No, I don't</button><button class="btn btn-primary" type="button">Yes, proceed</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
