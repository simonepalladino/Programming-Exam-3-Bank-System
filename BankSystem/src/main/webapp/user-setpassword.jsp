                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5" style="margin-bottom: -17px;padding-top: 91px;padding-bottom: 91px;margin-top: 3px;">
                            ...
                            <form method="post">
                                <div class="mb-3"><input class="form-control" type="password" id="name-2" name="password1" placeholder="Insert password"></div>
                                <div class="mb-3"><input class="form-control" type="password" id="email-2" name="password2" placeholder="Repeat password"></div><small class="text-danger">Password does not match!</small>
                                <div class="mb-3"></div>
